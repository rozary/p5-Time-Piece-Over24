# This Makefile is for the Time::Piece::Over24 extension to perl.
#
...
#     ABSTRACT => q[Adds over 24:00:00 methods to Time::Piece]
#     AUTHOR => q[Syunsuke Fujishiro]
#     BUILD_REQUIRES => { Test::More=>q[0], ExtUtils::MakeMaker=>q[6.42] }
#     DISTNAME => q[Time-Piece-Over24]
#     LICENSE => q[perl]
#     NAME => q[Time::Piece::Over24]
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0], ExtUtils::MakeMaker=>q[6.42], Time::Piece=>q[0] }
#     VERSION => q[0.011]
#     VERSION_FROM => q[lib/Time/Piece/Over24.pm]
...
MAKE = make
FULLEXT = Time/Piece/Over24
BASEEXT = Over24
PARENT_NAME = Time::Piece
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Time/Piece/Over24.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Time/Piece/Over24.pm
...
TO_INST_PM = lib/Time/Piece/Over24.pm

PM_TO_BLIB = lib/Time/Piece/Over24.pm \
...
DISTNAME = Time-Piece-Over24
DISTVNAME = Time-Piece-Over24-0.011
...
manifypods : pure_all  \
	lib/Time/Piece/Over24.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Time/Piece/Over24.pm $(INST_MAN3DIR)/Time::Piece::Over24.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Adds over 24:00:00 methods to Time::Piece</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Syunsuke Fujishiro</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Time/Piece/Over24.pm blib/lib/Time/Piece/Over24.pm 
